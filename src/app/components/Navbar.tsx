          ...
          <div className={`flex-1 ${isSmallScreen ? 'hidden' : 'flex'} justify-center`}>
            <div className="flex space-x-8">
              ...
              <div className="relative group">
                ...
                {/* Dropdown Icon */}
                <svg
                  className="h-5 w-5 text-white ml-1 inline"
                ...
                <div className="absolute left-0 hidden bg-black group-hover:block">
                  <motion.a
                    href="#games"
                    className={`block px-4 py-2 text-white hover:text-custom-orange`}
                  >
                    Games
                  </motion.a>
                </div>
